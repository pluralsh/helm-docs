...
**Homepage:** <https://github.com/pluralsh/helm-docs/tree/master/example-charts/ignored-values-example>
...
* <https://github.com/pluralsh/helm-docs/tree/master/example-charts/ignored-values-example>
...
| config.databasesToCreate[1] | string | `"hashbash"` | database for the [hashbash](https://github.com/pluralsh/hashbash) project |
