...
import (
	...
	"github.com/pluralsh/helm-docs/pkg/util"
...
func getHelmDocsVersionTemplates() string {
	...
	versionSectionBuilder.WriteString("Autogenerated from chart metadata using [helm-docs v{{ .HelmDocsVersion }}](https://github.com/pluralsh/helm-docs/releases/v{{ .HelmDocsVersion }})")
